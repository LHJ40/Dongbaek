...
$(function(){
    ...
    $("#createScheduel").on("click", function(){
        ...
        let roomName = ""; // 초기화된 빈 문자열로 시작합니다.
        let roomArray = []; // 초기화된 빈 문자열로 시작합니다.
...
//                     movieInfo += item.movie_num + ': ' item.movie_name_kr + '?';
                ...
                roomNameArray = roomName.split('?'); // ?를 기준으로 배열로 분할합니다.
...
//                 let movieInfoArray = html.split('?');
                ...
                $(".movieSelect").on("change",function(){
                	alert($(".movieSelect").val() + $().val()); // movie_num 출력됨
...
<!-- 	      <th scope="col"></th> -->
	  ...
	  <%-- 1번쨰 줄 --%>
		<tr>
			...
			<%-- 상영목록이 출력될 공간  --%>
				...
				<td>
				<div class="row mb-2"><button type="button" class="btn btn-outline-danger" style="height:60px;" style="height:60px;" onclick="createSchedule">생성</button></div>
	  ...
	  <%-- 2번쨰 줄 --%>
		<tr>
			...
			<div id="play2">
			<%-- 상영목록이 출력될 공간  --%>
				<td><div id="turn7">상영정보 없음</div><input type="checkbox" id="scheduelCheck2_1"></td>
				<td><div id="turn8">상영정보 없음</div><input type="checkbox" id="scheduelCheck2_2"></td>
				<td><div id="turn9">상영정보 없음</div><input type="checkbox" id="scheduelCheck2_3"></td>
				<td><div id="turn10">상영정보 없음</div><input type="checkbox" id="scheduelCheck2_4"></td>
				<td><div id="turn11">상영정보 없음</div><input type="checkbox" id="scheduelCheck2_5"></td>
				<td>
	  ...
	  <%-- 3번째 줄 --%>
		<tr>
			...
			<div id="play3">
			<%-- 상영목록이 출력될 공간  --%>
				<td><div id="turn13">상영정보 없음</div><input type="checkbox" id="scheduelCheck3_1"></td>
				<td><div id="turn14">상영정보 없음</div><input type="checkbox" id="scheduelCheck3_2"></td>
				<td><div id="turn15">상영정보 없음</div><input type="checkbox" id="scheduelCheck3_3"></td>
				<td><div id="turn16">상영정보 없음</div><input type="checkbox" id="scheduelCheck3_4"></td>
				<td><div id="turn17">상영정보 없음</div><input type="checkbox" id="scheduelCheck3_5"></td>
				<td>
				<div class="row mb-2"><button type="button" class="btn btn-outline-danger" style="height:60px;" onclick="createSchedule">생성</button></div>
				<div class="row"><button type="button" class="btn btn-danger" style="height:60px;" onclick="rewriteSchedule">수정</button></div>
				<td>
