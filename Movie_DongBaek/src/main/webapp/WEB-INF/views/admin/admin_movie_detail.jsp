...
<div class="container-fluid w-900 justify-content-center" style="border: 1px solid gray">
	...
	<!-- 			    </tr> -->
				    ...
				    <tr>
				    	...
				    	<td colspan="2">
				    		<input type="text" name="movie_name_kr" id="movie_name_kr" value="${movie.movie_name_kr }" required="required">
				    	</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 영화제목(en)</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_name_en" id="movie_name_en" value="${movie.movie_name_en }" required="required">
				   		</td>
				   		
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 감독</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_director" id="movie_director" value="${movie.movie_director }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 출연진</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_cast" id="movie_cast" value="${movie.movie_cast }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 장르</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_genre" id="movie_genre" value="${movie.movie_genre }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 개봉일</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_release_date" id="movie_release_date" value="${movie.movie_release_date }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 종영일</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_close_date" id="movie_close_date" value="${movie.movie_close_date }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 상영시간</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_running_time" id="movie_running_time" value="${movie.movie_running_time }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 관람객수</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_audience_num" id="movie_audience_num" value="${movie.movie_audience_num }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 줄거리</th>
				    	<td colspan="2">
				    		<textarea rows="5" cols="50" name="movie_content" id="movie_content" required="required">${movie.movie_content }</textarea>
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 관람등급</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_grade" id="movie_grade" value="${movie.movie_grade }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 포스터이미지</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_poster" id="movie_poster" value="${movie.movie_poster }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 예고영상</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_preview" id="movie_preview" value="${movie.movie_preview }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 스틸컷1</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_photo1" id="movie_photo1" value="${movie.movie_photo1 }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 스틸컷2</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_photo2" id="movie_photo2" value="${movie.movie_photo2 }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th><span style="color:red; font-size: 0.7em;">*</span> 스틸컷3</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_photo3" id="movie_photo3" value="${movie.movie_photo3 }" required="required">
				   		</td>
				    </tr>
				    <tr>
				    	<th>예매율</th>
				    	<td colspan="2">
				    		<input type="text" name="movie_booking_rate" id="movie_booking_rate" value="${movie.movie_booking_rate }">
				   		</td>
				    </tr>
				</table>
		    </form>
	...
	<div class="row d-flex justify-content-center mt-3">
		...
		<div class="col-3">
  <button class="w-100 btn btn-outline-red mb-3" type="button" id="modify-button">수정</button>
</div>
		<div class="col-3">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="modify-confirm">예</button>
      </div>
    </div>
  </div>
</div>
