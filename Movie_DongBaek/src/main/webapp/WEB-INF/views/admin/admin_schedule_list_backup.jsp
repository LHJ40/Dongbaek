...
<%-- <script src="${pageContext.request.contextPath }/resources/js/jquery-3.7.0.js"></script"></script> <!-- 추가 --%>

<script type="text/javascript">

<%-- 상단 버튼 클릭 시 ajax 함수 호출 --%>
$(function(){
    $('#createScheduel').on('click',loadScheduleList);}
...
function ajaxHtml(data){
	var html="<table class="table table-striped text-center align-middle">
	  <%-- 테이블 헤드 --%>
	  <thead>
	    <tr>
