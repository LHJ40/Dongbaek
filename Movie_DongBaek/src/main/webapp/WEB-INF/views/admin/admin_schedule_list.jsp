...
// 			    	                       <div class="font-weight-bold"> 극장번호 :<br></div><div> ' + sch[j].theater_num + '</div>\
			...
			//					        alert(data[i].movie_name_kr + ', ' + data[i].play_turn);
								        ...
								        for (let j = 0; j < result1.length; j++) {
								            if (result1[j].play_turn === i + 1) {
								              found = true;
								              schedule1 += '<div class="font-weight-bold">미등록<br></div><div></div>\
	...
	//	 					        alert(data[i].movie_name_kr + ', ' + data[i].play_turn);
							        ...
							        for (let j = 0; j < result2.length; j++) {
							            if (result2[j].play_turn === i + 1) {
							              found = true;
							              schedule2 += '<div class="font-weight-bold">미등록<br></div><div></div>\
	...
	//	 					        alert(data[i].movie_name_kr + ', ' + data[i].play_turn);
							        ...
							        for (let j = 0; j < result3.length; j++) {
							            if (result3[j].play_turn === i + 1) {
							              found = true;
							              schedule3 += '<div class="font-weight-bold">미등록<br></div><div></div>\
...
<!--   	<div id="hide_div" class="row" style="display: none;"> -->
    ...
    <tr>
      ...
      <td class="align-middle text-center">
        <div class="row mb-2"><button type="button" class="btn btn-outline-danger" style="height:120px; width:60px;" id="newSchedule1">생성수정</button></div>
    ...
    <tr>
      <td class="text-center">
          ...
          <div class="row">
            ...
            <select class="movieSelect" id="movieBox2" style="width:150px;">
              <option value="영화명">영화명</option>
            </select>
          </div>
      </td>
      ...
      <td class="align-middle text-center">
        <div class="row mb-2 "><button type="submit" class="btn btn-outline-danger" style="height:120px; width:60px;" id="newSchedule2">생성수정</button></div>
    ...
    <tr>
      <td class="text-center">
          ...
          <div class="row">
            ...
            <select class="movieSelect" id="movieBox3" style="width:150px;">
              <option value="영화명">영화명</option>
            </select>
          </div>
      </td>
      ...
      <td class="align-middle text-center">
        <div class="row mb-2"><button type="submit" class="btn btn-outline-danger"  style="height:120px; width:60px;" id="newSchedule3">생성수정</button></div>
